...
import dgtic.unam.modulosiete.Adapters.SonidoAdapter
import dgtic.unam.modulosiete.Models.SonidoModelo
...
class SonidoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (stadoSD == Environment.MEDIA_MOUNTED) {
            ...
            archivos.add(
                SonidoModelo("Magenta_Moon_Part_II.mp3",R.drawable.musica_img,
